  ...
  const timelineEvents = [
    {
      year: 2001,
      title: 'Freshman Year',
      description: 'We began our high school journey at Krong Ana High School.',
      icon: '🏫',
    },
    {
      year: 2003,
            ...
            {timelineEvents.map((event, index) => (
              ...
              >
                <div className={`w-1/2 ${index % 2 === 0 ? 'pr-16 text-right' : 'pl-16'}`}>
                  <div 
                    className={`bg-white p-6 rounded-lg shadow-md transform transition duration-500 hover:-translate-y-2 hover:shadow-xl ${
                      index % 2 === 0 ? 'mr-4' : 'ml-4'
                    }`}
                  >
