      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Tham gia cùng chúng tôi trong ba ngày hội ngộ. Từ những buổi gặp gỡ thân mật đến các buổi lễ trang trọng,
            chúng tôi đã lên kế hoạch cho một trải nghiệm khó quên.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center mb-12 space-x-2">
          <button
            className={`px-6 py-3 rounded-full font-medium transition-colors mb-2 ${selectedDay === '2025-07-15'
          ...
          <button
            className={`px-6 py-3 rounded-full font-medium transition-colors mb-2 ${selectedDay === '2025-07-16'
              ? 'bg-indigo-700 text-white'
              : 'bg-white text-indigo-700 hover:bg-indigo-100'
              }`}
          ...
          <button
            className={`px-6 py-3 rounded-full font-medium transition-colors mb-2 ${selectedDay === '2025-07-17'
              ? 'bg-indigo-700 text-white'
              : 'bg-white text-indigo-700 hover:bg-indigo-100'
              }`}
